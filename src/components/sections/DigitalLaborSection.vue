<template>
  <section id="digital-labor" class="section concept-section fullscreen">
    ...
    <p class="concept-intro">你有没有想过自己是在劳动，而屏幕那头的儿童或许在进行另一种看不见的劳动。</p>
    <div class="concept-box">
      ...
      <p class="concept-explain">简单来说就是在互联网世界里，为平台创造价值却可能得不到相应报酬的"隐形打工人"。平台通过算法和规则，让用户不知不觉投入时间精力，最终把这些变成流量和商业利益。</p>
    </div>
  </section>
</template>
